...
class SeedOssReasoningParser(ReasoningParser):
    """
    Reasoning parser for Seed-OSS model.

    The Seed-OSS model uses <seed:think>...</seed:think> tokens to denote reasoning
    ...
    def extract_reasoning_content_streaming(
        ...
        if self.think_start_token_id in previous_token_ids:
            if self.think_end_token_id in delta_token_ids:
                ...
                # <seed:think> in previous, no </seed:think> in previous or delta,
                # reasoning content continues
                return DeltaMessage(reasoning_content=delta_text)
        elif self.think_start_token_id in delta_token_ids:
            if self.think_end_token_id in delta_token_ids:
                # <seed:think> in delta, </seed:think> in delta, extract reasoning content
            ...
            # No <seed:think> in previous or delta, also need to check for </seed:think>.
            if self.think_end_token_id in delta_token_ids:
                # </seed:think> in delta with more tokens,
                ...
                # </seed:think> in previous, thinking content ends
                return DeltaMessage(content=delta_text)
            else:
                # no </seed:think> in previous or delta, reasoning content continues
                return DeltaMessage(reasoning_content=delta_text)
    ...
    def extract_reasoning_content(
        ...
        # Check if the model output contains the </seed:think> token.
